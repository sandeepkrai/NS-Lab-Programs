...
main (int argc, char *argv[])
{
  ...
  NetDeviceContainer nd0 = p2p.Install (c0);  // First LAN
  ...
  csma.EnableAsciiAll (ascii.CreateFileStream ("LAB4/l3_q1_multi.tr"));
  p2p.EnableAsciiAll (ascii.CreateFileStream ("LAB4/l3_q1_multi.tr"));
  AnimationInterface anim ("l3_q1_multi.xml");
