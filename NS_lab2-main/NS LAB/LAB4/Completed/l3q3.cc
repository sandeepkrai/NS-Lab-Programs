...
main (int argc, char *argv[])
{
  ...
  ApplicationContainer sinkC = sink.Install (c.Get (5)); // Node n4 
  // Start the sink
  ...
  csma.EnableAsciiAll (ascii.CreateFileStream ("LAB4/l3_q3.tr"));
  p2p.EnableAsciiAll (ascii.CreateFileStream ("LAB4/l3_q3.tr"));
  AnimationInterface anim ("LAB4/l3_q3.xml");
